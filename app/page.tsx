...
export default function Page() {
  return (
    <main className="flex min-h-screen flex-col p-6">
      <div className="flex h-20 shrink-0 items-center rounded-lg p-4 md:h-52">
        <AcmeLogo />
      </div>
      <div className="mt-4 flex flex-col justify-center gap-4 md:flex-row">
        <div className="flex flex-col justify-center gap-6 rounded-lg bg-gray-50 px-6 py-10 md:w-2/5 md:px-20">
          ...
          <Link href="https://fractalcrypto.tech/" target="_blank" className="flex items-center gap-5 self-start rounded-lg bg-blue-500 px-6 py-3 text-sm font-medium text-white transition-colors hover:bg-blue-400 md:text-base">
            <span>Sitio web informativo</span> <GlobeAltIcon className="w-5 md:w-6" />
          </Link>
        </div>
