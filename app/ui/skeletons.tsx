...
export function CardSkeleton() {
  return (
    <div
      className={`${shimmer} relative overflow-hidden rounded-xl bg-gray-100 p-2 shadow-sm dark:bg-gray-800 dark:text-gray-100`}
    >
  ...
  return (
    <div className={`${shimmer} relative w-full overflow-hidden md:col-span-4`}>
      ...
      <div className="rounded-xl bg-gray-100 p-4 dark:bg-gray-800">
        <div className="mt-0 grid h-[410px] grid-cols-12 items-end gap-2 rounded-md bg-white p-4 sm:grid-cols-13 md:gap-4 dark:bg-gray-900" />
...
export function InvoicesMobileSkeleton() {
  return (
    <div className="mb-2 w-full rounded-md bg-white p-4 dark:bg-gray-900">
      ...
      <div className="flex w-full items-center justify-between pt-4 dark:bg-gray-900">
        <div>
          <div className="h-6 w-16 rounded bg-gray-100 dark:bg-gray-700"></div>
